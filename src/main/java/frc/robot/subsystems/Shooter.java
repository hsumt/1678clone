...
// Shooter Wheel subsystem:
// 1 Kraken x60 
// Lxx of subsystem (whichever one is in the axis of rotation)
// for the shooter just find the moi of one andymark 4 in stealth wheel and multiply by the number of wheels
