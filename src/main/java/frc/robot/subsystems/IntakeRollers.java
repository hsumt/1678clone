...
public class IntakeRollers extends SubsystemBase {
  public class rollerConstants {
    ...
    public static final Voltage INTAKE_IN = Volts.of(6);
    public static final Voltage INTAKE_OUT = Volts.of(-6);
  ...
  private SmartMotorController rollerSMC = new TalonFXWrapper(rollerMotor, DCMotor.getKrakenX60(1), smcConfig);
  ...
  public Command intakeIn() {
    return run(() -> roller.setVoltage(rollerConstants.INTAKE_IN));
  }
  public Command intakeOut() {
    return run(() -> roller.setVoltage(rollerConstants.INTAKE_OUT));
  }
  public Command intakeStop() {
    return run(() -> rollerMotor.setVoltage(0));
  }
